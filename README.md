...
```yaml
Name     : Barot Joy Mukeshbhai
Role     : Senior Talent Acquisition Specialist – US Staffing
Company  : SkyLight Placements LLC
Location : Mehsana, Gujarat, India 🇮🇳
Education: BCA – Ganpat University (2024)
Email    : joybarotjb1@gmail.com
```

- 🔭 Currently working on **US IT & Non-IT Staffing** at SkyLight Placements LLC
- 🌱 Learning **Web Development** — HTML, CSS, JavaScript
- 💼 Previously worked at **IFSCA** (Banking Regulation) & **Tech Mahindra** (Web Development)
- 🎯 Goal: Combine **recruitment expertise** with **tech skills**
- ⚡ Fun fact: I help people find jobs while building my own tech portfolio!
...
![US Staffing](https://img.shields.io/badge/US_Staffing-4ECDC4?style=for-the-badge)
![Banking](https://img.shields.io/badge/Banking_&_Finance-45B7D1?style=for-the-badge)
![Communication](https://img.shields.io/badge/Client_Communication-96CEB4?style=for-the-badge)

---

## 🚀 Projects

### 📋 [JobTrack – Job Application Tracker](https://joybarotjb1.github.io/job-tracker)
> A clean, dark-themed web app to track job applications — built with pure HTML, CSS & JavaScript

- ✅ Add & manage job applications with company, role & date
- ✅ Track status: Applied → Interview → Offer / Rejected / Ghosted
- ✅ Live pipeline dashboard with real-time counts
- ✅ Filter by status & add notes
- ✅ Data saved in browser (localStorage)
- ✅ Fully responsive on mobile

**Tech:** `HTML5` `CSS3` `JavaScript` `localStorage`

[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-FF5722?style=for-the-badge)](https://joybarotjb1.github.io/job-tracker)
[![GitHub Repo](https://img.shields.io/badge/📁_Source_Code-100000?style=for-the-badge&logo=github)](https://github.com/joybarotjb1/job-tracker)
...
| Role | Company | Period |
|------|---------|--------|
| 🎯 Senior Talent Acquisition Specialist | SkyLight Placements LLC | Apr 2025 – Present |
| 🏦 Senior Associate – Banking | IFSCA, Gandhinagar | Sep 2024 – Mar 2025 |
| 💻 Assistant Web Developer | Tech Mahindra, GiftCity | May 2024 – Sep 2024 |
...
💼 Open to **Web Development** and **HR Tech** opportunities!

[![LinkedIn](https://img.shields.io/badge/Connect_on_LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/joy-barot-6aa823283)
[![Email](https://img.shields.io/badge/Send_an_Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:joybarotjb1@gmail.com)
